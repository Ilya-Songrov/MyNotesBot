...
//    const auto vecNeeds = managerDatabase->getVecNotes(callbackQuery->message->chat->id, ManagerDatabase::PrayerNeedsAll);
//    QString needs;
...
//    const auto vecNeeds = managerDatabase->getVecNotes(callbackQuery->message->chat->id);
